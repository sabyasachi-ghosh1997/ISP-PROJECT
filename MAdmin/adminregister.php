                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30">
                            ...
                            <form action="#">
                                <div class="login-form">
                                    <h4 class="login-title">Admin Register</h4>
                                    <div class="row">
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>Full Name</label>
                                            <input class="mb-0" type="text" name="Name" placeholder="First Name" required>
                                        </div>
                                        <div class="col-md-6 col-12 mb-20">
                                            <label>Phone Number</label>
                                            <input class="mb-0" type="text" name="PhNo" placeholder="Phone Number" required>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-20">
                                            ...
                                            <input class="mb-0" type="password" name="Confirm Password" placeholder="Confirm Password" required>
                                        </div>
                                        <div class="col-12">

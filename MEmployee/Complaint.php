...
<?php
    ...
    $Selectqry="select * from Complaint";
...
?>
            <tr>
                ...
                <td><a href="Complaint.php?ComplaintId=<?php echo $r["Cmpid"];?>& Status=<?php echo $r["Status"];?>"><?php if($r["Status"]==1) echo "Active"; else echo"Deactive";?></a></td>

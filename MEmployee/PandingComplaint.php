...
<?php
    $Selectqry="select * from Complaint WHERE Status=1";
...
?>
            <tr>
                ...
                <td><a href="PandingComplaint.php?ComplaintId=<?php echo $r["Cmpid"];?>& Status=<?php echo $r["Status"];?>"><?php if($r["Status"]==1) echo "Active"; else echo"Deactive";?></a></td>
